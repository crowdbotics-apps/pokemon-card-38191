"""
Django settings for pokemon_card_38191 project.
...
ROOT_URLCONF = 'pokemon_card_38191.urls'
...
WSGI_APPLICATION = 'pokemon_card_38191.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "pokemon_card_38191 API",
    "DESCRIPTION": "API documentation for pokemon_card_38191 App",
    "VERSION": "v1",
}
